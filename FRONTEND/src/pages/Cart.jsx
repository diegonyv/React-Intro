...
const Cart = () => {
  ...
  const checkout = async () => {
    try {
      const cart = Object.values(orderDetail).flat();
  ...
  return (
    <>
      <div className="container mb-5">
            ...
            pizzaList.length > 0 && (
              <div key={indice} className="d-flex m-5">
                ...
                <div className="d-flex align-items-center">
                  <button
                    onClick={() =>
                      modificarCarrito("suma", pizzaList, pizzaName)
                    }
                  ...
                  <button
                    onClick={() =>
                      modificarCarrito("resta", pizzaList, pizzaName)
                    }
        ...
        <button className="btn btn-dark" disabled={!token} onClick={checkout}>
          Pagar
        </button>
      </div>
    </>
